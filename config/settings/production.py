...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["tabithatalking.com"])
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Tabitha Talking <noreply@tabithatalking.com>",
)
...
WAGTAILADMIN_BASE_URL = env(
    ...
    default="https://tabithatalking.com",
)
